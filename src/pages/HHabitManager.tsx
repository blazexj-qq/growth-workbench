...
export default function HHabitManager() {
  const { records, addRecord, deleteRecord, clearRecords, syncFromCloud } = useHabitStore()
        ...
        items={[
          {
            ...
            children: (
              <Row gutter={16}>
                <Col xs={24} md={8}>
                  <Card size="small" title="打卡一条习惯">
                    <Form form={form} layout="vertical" onFinish={onAdd} initialValues={{ completed: 1 }}>
